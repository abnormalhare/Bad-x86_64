...
JMP_1306:
    { Data data = {0, .rm_code = 0xC0 }; ASM_0F(0x95, &data); }
...
JMP_175C:
    ...
    { Data data = {0, .rm_code = 0xC2 }; ASM_4X(0x48); ASM_0F(0x45, &data); }
    ASM_4X(0x48); ASM_8B(0xD0, 0x00, 0x00);
    ASM_4X(0x48); ASM_89(0x04, 0x24, 0x00);
...
JMP_1792:
    ASM_33(0xD2, 0x00, 0x00);
    ASM_4X(0x48); ASM_89(0x14, 0x24, 0x00);
...
void ASM__get_image_app_type(void) {
    ...
    ASM_74(0x1C, 17E6);
    ASM_BH(0xB9, 0x02);
    ASM_66(); ASM_39(0x48, 0x00, 0x5C);
    ASM_75(0x04, 17D9);
    ASM_8B(0xC1, 0x00, 0x00);
    ASM_EB(0x0F, 17E8);

JMP_17D9:
    ASM_66(); ASM_83(0x78, 0x00, 0x5C, 0x03);
    ASM_BH(0xB9, 0x01);
    { Data data = {0, .rm_code = 0xD9 }; ASM_0F(0x44, &data); }

JMP_17E6:
    ASM_8B(0xC3, 0x00, 0x00);
